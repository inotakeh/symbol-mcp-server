...
export const monthlyHealthCheckPrompt = definePrompt({
  ...
  description:
    "One-screen monthly report for a Symbol voting / harvesting node: version and sync, service health and version drift, lag against reference nodes, unlocked harvesters, voting key expiry, balance versus minVoterBalance, and last month's harvest income, sorted into Action required / Attention / Normal.",
...
5. symbol_harvesting_status: record the number of delegated harvesters unlocked on the node. Ask the operator what the number was at the previous check and flag a decrease.
